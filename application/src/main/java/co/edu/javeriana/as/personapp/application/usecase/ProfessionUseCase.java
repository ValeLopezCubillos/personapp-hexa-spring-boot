...
public class ProfessionUseCase implements ProfessionInputPort {
    ...
    public Profession edit(Integer id, Profession profession) throws NoExistException {
        ...
        throw new NoExistException(
                "The profession with id " + id + " does not exist into db, cannot be edited");
    }
    ...
    public Boolean drop(Integer id) throws NoExistException {
        ...
        throw new NoExistException(
                "The profession with id " + id + " does not exist into db, cannot be dropped");
    }
    ...
    public List<Study> getStudies(Integer id) throws NoExistException {
        ...
        throw new NoExistException(
                "The profession with id " + id + " does not exist into db, cannot be getting studies");
    }
}
